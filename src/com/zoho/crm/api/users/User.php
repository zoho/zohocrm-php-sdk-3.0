...
class User extends Record implements Model
{
	 ...
	 * @return string A string representing the numberSeparator
	 */
	 ...
	 * @param string $numberSeparator A string
	 */
	public  function setNumberSeparator(string $numberSeparator)
	{
	 ...
	 * @param \DateTime $shiftEffectiveFrom An instance of \DateTime
	 */
	public  function setShiftEffectiveFrom(\DateTime $shiftEffectiveFrom)
	{
