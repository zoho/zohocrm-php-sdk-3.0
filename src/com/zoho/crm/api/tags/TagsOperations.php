...
class TagsOperations
{
	...
	public  function getTags(ParameterMap $paramInstance=null)
	{
		...
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v3/settings/tags'); 
	 ...
	 * @return APIResponse An instance of APIResponse
	 */
	public  function addTagsToRecord(string $recordId, string $moduleAPIName, BodyWrapper $request, ParameterMap $paramInstance=null)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
	 ...
	 * @return APIResponse An instance of APIResponse
	 */
	public  function removeTagsFromRecord(string $recordId, string $moduleAPIName, BodyWrapper $request, ParameterMap $paramInstance=null)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v3/'); 
	 ...
	 * @return APIResponse An instance of APIResponse
	 */
	public  function addTagsToMultipleRecords(string $moduleAPIName, BodyWrapper $request, ParameterMap $paramInstance=null)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v3/'); 
	 ...
	 * @return APIResponse An instance of APIResponse
	 */
	public  function removeTagsFromMultipleRecords(string $moduleAPIName, BodyWrapper $request, ParameterMap $paramInstance=null)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v3/'); 
