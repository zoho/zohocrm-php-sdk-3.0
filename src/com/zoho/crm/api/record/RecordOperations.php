...
class RecordOperations
{
	 ...
	 * @return APIResponse An instance of APIResponse
	 */
	public  function assignTerritoriesToMultipleRecords(string $moduleAPIName, BodyWrapper $request)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v3/'); 
	 ...
	 * @return APIResponse An instance of APIResponse
	 */
	public  function assignTerritoryToRecord(string $moduleAPIName, string $id, BodyWrapper $request)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v3/'); 
	 ...
	 * @return APIResponse An instance of APIResponse
	 */
	public  function removeTerritoriesFromMultipleRecords(string $moduleAPIName, BodyWrapper $request)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v3/'); 
	 ...
	 * @return APIResponse An instance of APIResponse
	 */
	public  function removeTerritoriesFromRecord(string $moduleAPIName, string $id, BodyWrapper $request)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v3/'); 
	 ...
	 * @return APIResponse An instance of APIResponse
	 */
	public  function recordCount(string $moduleAPIName, ParameterMap $paramInstance=null)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v3/'); 
	 ...
	 * @return APIResponse An instance of APIResponse
	 */
	public  function leadConversionOptions(string $id, string $moduleAPIName)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v3/'); 
