...
class RolesOperations
{
	...
	public  function getRoles()
	{
		...
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v3/settings/roles'); 
	 ...
	 * @return APIResponse An instance of APIResponse
	 */
	public  function updateRole(string $id, BodyWrapper $request)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v3/settings/roles/'); 
	 ...
	 * @return APIResponse An instance of APIResponse
	 */
	public  function deleteRole(string $id, ParameterMap $paramInstance=null)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v3/settings/roles/'); 
